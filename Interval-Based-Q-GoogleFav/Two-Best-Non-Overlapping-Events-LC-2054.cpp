...
int main() {
    ...
    SolutionMemo solution; // Use Solution for brute force or SolutionMemo for memoization

    // Sample input: a vector of events where each event is represented as {start_time, end_time, value}
    vector<vector<int>> events = {{1, 3, 3}, {3, 4, 4}, {5, 6, 5}, {7, 8, 8}};

    // Call the function and print the result
    int maxValue = solution.maxTwoEvents(events);
    
    cout << "Maximum value from two non-overlapping events: " << maxValue << endl;
