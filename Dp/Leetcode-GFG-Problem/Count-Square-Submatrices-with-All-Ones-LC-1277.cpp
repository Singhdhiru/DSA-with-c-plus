...
int main() {
    ...
    Solution solution;
    int resultMemoization = solution.countSquares(grid);
    cout << "Total squares using memoization: " << resultMemoization << endl;

    // Using the bottom-up approach
    Solution solutionBottomUp;
    int resultBottomUp = solutionBottomUp.countSquares(grid);
    cout << "Total squares using bottom-up: " << resultBottomUp << endl;
